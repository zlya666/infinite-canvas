export default {
    ...
    auth: {
        title: "Sign in",
        description: "Sign in with your team account to keep canvas projects isolated and synced to the cloud.",
        login: "Sign in",
        register: "Sign up",
        logout: "Sign out",
        email: "Email",
        ...
        registerCheckEmail: "Account created. Check your email to confirm, then sign in.",
        registerFailed: "Sign-up failed",
        logoutSuccess: "Signed out",
        logoutFailed: "Sign-out failed",
        syncFailed: "Canvas cloud sync failed",
        notConfigured: "Supabase is not configured. The app stays in local-only mode. Set these in web/.env:",
